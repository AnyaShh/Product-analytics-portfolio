# Superset: Retention рекламной кампании + расследование падения DAU
...
## Цель
Выяснить, что произошло с retention рекламных пользователей и есть ли признаки продуктовой/технической проблемы в день падения.
